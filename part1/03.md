...
- `db_set`: good performance
    - `log`: ***append-only, immutable*** sequence of records
...
- `db_get`: O(n) terrible performance 
...
### LSM-Trees(Log-Structured Merge-Tree) (log)
Examples
...
- Downsides of LSM-Trees
    ...
    2. compaction may ont keep up with the rate of incoming writes
...
1. No compaction 
2. Each key exists in ***exactly one place*** in the index
